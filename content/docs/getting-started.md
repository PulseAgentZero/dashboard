...
3. Add your first [data connection](/docs/data-sources) under **Data & pipeline → Connections**.
...
After setup, browse **[Product features](/docs/features)** for a guide to Entities, Recommendations, Analytics, Studio, Agent, Alerts, and the rest of the dashboard.

### API keys (optional)

For integrations, open **Settings → API keys**, create a key, and use the [API Playground](/dashboard/playground) (sidebar: **Developer → Playground**) or [Public API docs](/docs/api/overview).
